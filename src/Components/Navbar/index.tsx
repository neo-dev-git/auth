...
const Nav: React.FC<Props> = ({ dappDetails, params, tokenDetails }) => {
  return (
      ...
      <div className="w-full h-full border-b-2 border-zinc-500 border-opacity-10 justify-center items-center gap-4 inline-flex">
        <div className="grow shrink basis-0 h-[74px] py-3 justify-start items-center gap-3 flex">
          <div className=" relative">
            <img className=" left-0 top-0 absolute rounded-[50px]" src="/icons/boy.svg" />
