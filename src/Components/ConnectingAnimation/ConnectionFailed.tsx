...
export default function ConnectionFailed() {
  ...
  <div className="self-stretch py-2 justify-center items-center gap-2 inline-flex">
    ...
    <div className="w-[100px] h-9 relative">
      ...
      <div className="w-9 h-9 left-[34px] top-0 absolute">
        ...
        <img src='/icons/tick-circle2.svg'></img>
  ...
  <div className="self-stretch h-[79px] py-3 mix-blend-difference flex-col justify-center items-start gap-4 flex">
    <div className="self-stretch justify-center items-center gap-2 inline-flex">
      <div className="text-center text-white text-opacity-80 text-lg font-medium font-['Montserrat'] leading-snug">Connection failed...</div>
    </div>
    <div className="self-stretch justify-center items-center gap-2 inline-flex">
      <div className="text-center text-white text-opacity-60 text-sm font-medium font-['Montserrat'] leading-[16.80px]">Please retry connecting to the wallet</div>
    </div>
  </div>
