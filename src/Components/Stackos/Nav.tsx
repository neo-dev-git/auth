...
export default function Nav() {
  ...
  return (
    <div>
      ...
      <div className="w-full  px-5 py-6 flex-col justify-center items-center gap-4 inline-flex">
        <div className="  relative bg-stone-950 rounded-[67.31px] shadow">
        ...
        <div className="self-stretch  py-3 flex-col justify-center items-start gap-4 flex">
          <div className="self-stretch justify-center items-center gap-2 inline-flex">
            <div className="text-center justify-center flex text-white text-opacity-80 text-lg font-medium font-['Montserrat'] leading-snug">Log in with {dappName}</div>
          </div>
        </div>
      </div>
    </div>
