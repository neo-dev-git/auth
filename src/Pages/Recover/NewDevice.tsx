  ...
  return (
    <div className='  '>
      <div className="w-full h-full min-h-screen dark:bg-fontLightColor bg-white rounded-2xl p-4 flex-col justify-between items-center inline-flex">
        ...
        <div className=" mb-auto mt-10 py-3 flex-col justify-center items-start gap-1 inline-flex">
        ...
        <div className=" flex-col  items-center gap-3 flex">
          <div className="  px-5 py-4 rounded-2xl border border-violet-400 border-opacity-30 flex-col justify-center items-center gap-2 inline-flex">
