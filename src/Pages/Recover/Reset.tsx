...
export default function Reset() {
    ...
    return (
        <div>
            <div className="w-full h-full min-h-screen p-4 dark:bg-fontLightColor bg-white rounded-2xl flex-col justify-between items-center inline-flex">
                <div className="flex-col w-full h-full justify-start items-center gap-2 flex">
                   
                    <Nav />
                    <div className="   mt-12 py-3 flex-col justify-center items-start gap-4 inline-flex">
                ...
                <div className="self-stretch   flex-col justify-center items-center gap-2 flex">
                    <div className="self-stretch  mb-2 flex-col justify-center items-center gap-3 flex">
                        ...
                        <div className="  flex-col w-full h-full justify-center items-center gap-3 inline-flex">
